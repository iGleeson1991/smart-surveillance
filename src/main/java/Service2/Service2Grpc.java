...
public final class Service2Grpc {
  ...
  private static volatile io.grpc.MethodDescriptor<Service2.CameraAdjustmentRequest,
      Service2.CameraAdjustmentResponse> getCameraAdjustmentMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "cameraAdjustment",
      requestType = Service2.CameraAdjustmentRequest.class,
      responseType = Service2.CameraAdjustmentResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<Service2.CameraAdjustmentRequest,
      Service2.CameraAdjustmentResponse> getCameraAdjustmentMethod() {
    io.grpc.MethodDescriptor<Service2.CameraAdjustmentRequest, Service2.CameraAdjustmentResponse> getCameraAdjustmentMethod;
      ...
      synchronized (Service2Grpc.class) {
        if ((getCameraAdjustmentMethod = Service2Grpc.getCameraAdjustmentMethod) == null) {
          Service2Grpc.getCameraAdjustmentMethod = getCameraAdjustmentMethod = 
              io.grpc.MethodDescriptor.<Service2.CameraAdjustmentRequest, Service2.CameraAdjustmentResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "Service2", "cameraAdjustment"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Service2.CameraAdjustmentRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Service2.CameraAdjustmentResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<Service2.MotionDetectedRequest,
      Service2.Empty> getMotionDetectedMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "motionDetected",
      requestType = Service2.MotionDetectedRequest.class,
      responseType = Service2.Empty.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<Service2.MotionDetectedRequest,
      Service2.Empty> getMotionDetectedMethod() {
    io.grpc.MethodDescriptor<Service2.MotionDetectedRequest, Service2.Empty> getMotionDetectedMethod;
      ...
      synchronized (Service2Grpc.class) {
        if ((getMotionDetectedMethod = Service2Grpc.getMotionDetectedMethod) == null) {
          Service2Grpc.getMotionDetectedMethod = getMotionDetectedMethod = 
              io.grpc.MethodDescriptor.<Service2.MotionDetectedRequest, Service2.Empty>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "Service2", "motionDetected"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Service2.MotionDetectedRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Service2.Empty.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<Service2.CameraAutomationRequest,
      Service2.CameraAutomationResponse> getCameraAutomationMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "cameraAutomation",
      requestType = Service2.CameraAutomationRequest.class,
      responseType = Service2.CameraAutomationResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<Service2.CameraAutomationRequest,
      Service2.CameraAutomationResponse> getCameraAutomationMethod() {
    io.grpc.MethodDescriptor<Service2.CameraAutomationRequest, Service2.CameraAutomationResponse> getCameraAutomationMethod;
      ...
      synchronized (Service2Grpc.class) {
        if ((getCameraAutomationMethod = Service2Grpc.getCameraAutomationMethod) == null) {
          Service2Grpc.getCameraAutomationMethod = getCameraAutomationMethod = 
              io.grpc.MethodDescriptor.<Service2.CameraAutomationRequest, Service2.CameraAutomationResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "Service2", "cameraAutomation"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Service2.CameraAutomationRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Service2.CameraAutomationResponse.getDefaultInstance()))
  ...
  public static abstract class Service2ImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<Service2.CameraAdjustmentRequest> cameraAdjustment(
        io.grpc.stub.StreamObserver<Service2.CameraAdjustmentResponse> responseObserver) {
      return asyncUnimplementedStreamingCall(getCameraAdjustmentMethod(), responseObserver);
    }

    /**
     */
    public void motionDetected(Service2.MotionDetectedRequest request,
        io.grpc.stub.StreamObserver<Service2.Empty> responseObserver) {
      asyncUnimplementedUnaryCall(getMotionDetectedMethod(), responseObserver);
    }

    /**
     */
    public io.grpc.stub.StreamObserver<Service2.CameraAutomationRequest> cameraAutomation(
        io.grpc.stub.StreamObserver<Service2.CameraAutomationResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncBidiStreamingCall(
              new MethodHandlers<
                Service2.CameraAdjustmentRequest,
                Service2.CameraAdjustmentResponse>(
                  this, METHODID_CAMERA_ADJUSTMENT)))
          .addMethod(
            getMotionDetectedMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                Service2.MotionDetectedRequest,
                Service2.Empty>(
          ...
          .addMethod(
            ...
            asyncBidiStreamingCall(
              new MethodHandlers<
                Service2.CameraAutomationRequest,
                Service2.CameraAutomationResponse>(
  ...
  public static final class Service2BlockingStub extends io.grpc.stub.AbstractStub<Service2BlockingStub> {
    ...
    /**
     */
    public Service2.Empty motionDetected(Service2.MotionDetectedRequest request) {
  ...
  public static final class Service2FutureStub extends io.grpc.stub.AbstractStub<Service2FutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<Service2.Empty> motionDetected(
        Service2.MotionDetectedRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_MOTION_DETECTED:
          serviceImpl.motionDetected((Service2.MotionDetectedRequest) request,
              (io.grpc.stub.StreamObserver<Service2.Empty>) responseObserver);
          break;
        default:
  ...
  private static abstract class Service2BaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return Service2.CameraControlsImpl.getDescriptor();
    }
